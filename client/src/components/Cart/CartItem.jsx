...
const CartItem = ({ name, price, image, id, amount }) => {
    ...
    const increaseAmountInLocalStorage = async (productID) => {
        ...
        window.localStorage.setItem(
            "products",
            JSON.stringify(productsFromCart)
        );
            ...
            <li className="flex border-b-slate-600 mb-2">
                <div className="flex">
                    ...
                    <div>
                        ...
                        <div>
                            <span className="font-bebas mr-6">
                                {" "}
                                Cant: {amount}
                            </span>
                            {currentUser ? (
                                <button
                                    onClick={() =>
                                        decreaseProduct(currentUser?.uid, id)
                                    }
                                ...
                                <button
                                    className="mr-3 text-3xl text-primary font-bold"
                                    onClick={() =>
                                        decreaseAmountInLocalStorage(id)
                                    }
                                >
                                    -
                                </button>
                            ...
                            {currentUser ? (
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        increaseAmountInLocalStorage(id)
                                    }
                                >
                                    +
                                </button>
